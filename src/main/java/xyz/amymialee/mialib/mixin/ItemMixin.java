...
public class ItemMixin implements MItem {
    ...
    private static class ItemSettingsMixin {
        ...
        private <T> Item.Settings mialib$nomaxdamage(Item.Settings instance, ComponentType<T> type, T value, Operation<Item.Settings> original) {
            if (value == (Integer) 0) return instance;
        ...
        private <T> Item.Settings mialib$nodamage(Item.Settings instance, ComponentType<T> type, T value, Operation<Item.Settings> original) {
            if (value == (Integer) 0) return instance;
            return original.call(instance, type, value);
        }
    }
