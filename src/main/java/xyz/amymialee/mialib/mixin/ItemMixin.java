...
public class ItemMixin {
    ...
    private static class ItemSettingsMixin {
        ...
        private <T> boolean mialib$noDurability1(Item.Settings instance, ComponentType<T> type, T value, int maxDamage) {
            return maxDamage != 0;
        }
        ...
        private <T> boolean mialib$noDurability2(Item.Settings instance, ComponentType<T> type, T value, int maxDamage) {
            return maxDamage != 0;
        }
    }
}